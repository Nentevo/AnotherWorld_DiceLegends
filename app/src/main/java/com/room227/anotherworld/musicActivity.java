...
public class musicActivity extends Activity implements View.OnClickListener {
    ...
    int status = 0x11;
    String[] titleStrs = {"Main Theme 1","Main Theme 2"};
    String[] authorStrs = {"原创","原创"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnExitmusic = (Button) findViewById(R.id.btn_exit);
        ...
        mBtnExitmusic.setOnClickListener(this);
    ...
    public void onClick(View source)
    {
        ...
        switch (source.getId())
        {
            ...
            case R.id.btn_exit:
                intent = new Intent(musicActivity.this, MainActivity.class);
